...
class Model(nn.Module):
    ...
    def build(self):
        ...
        self.hist_reg = nn.Linear(self.rnn_hid_size, 36)
    ...
    def forward(self, data, direct):
        ...
        for t in range(SEQ_LEN):
            x = values[:, t, :]
            m = masks[:, t, :]      # masks[t::]
            # masks[:, t, :] # => TODO IndexError: too many indices for tensor of dimension 1
            d = deltas[:, t, :]     # deltas[t::]
            # deltas[:, t, :] # => TODO IndexError: too many indices for tensor of dimension 1

            gamma_h = self.temp_decay_h(d) # => TODO size mismatch error
